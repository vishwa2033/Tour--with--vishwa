const data = [
	...
	},
	{
		id: 8,
		name: "Simla",
		info: "Shimla is the capital and the largest city of the northern Indian state of Himachal Pradesh.Shimla is famous for its stunning natural beauty, colonial architecture, and old-world charm.There are many places that command picturesque views of the sun rising or setting amidst the hill range at the horizon.",
		
		image: "https://images.unsplash.com/photo-1637199489922-2cb81819fcbb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2072&q=80",
		price: "30,595",
	},
	{
		id: 8,
		name: "Manali",
		info: "Manali is known for its shiny gompas or Buddhist monasteries. With the highest concentration of Tibetan refugees in the entire Kullu valley, it is famous for its Gadhan Thekchhokling Gompa, built in 1969.",
		
		image: "https://images.unsplash.com/photo-1605649487212-47bdab064df7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80",
		price: "35,595",
	},
];
